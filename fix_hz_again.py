...
old_hz = """                // Hz (Giới hạn tốc độ động cơ Bước - Stepper Motor Frequency)
...
new_hz = """                // Hz (Giới hạn tốc độ theo giao diện AutoCut của xưởng)
...
content = content.replace("3.4.7", "3.4.8")
